...
import (
	...
	"github.com/dean2021/sqlparser/charset"
	"github.com/dean2021/sqlparser/model"
	"github.com/dean2021/sqlparser/mysql"
	"github.com/dean2021/sqlparser/opcode"
	"github.com/dean2021/sqlparser/terror"
...
func (s *testParserSuite) TestDMLStmt(c *C) {
	table := []testCase{
		...
		// for https://github.com/dean2021/sqlparser/issues/963
...
func (s *testParserSuite) TestInsertStatementMemoryAllocation(c *C) {
	...
	_, err := parser2.New().ParseOneStmt(sql, "", "")
	c.Assert(err, IsNil)
...
func (s *testParserSuite) TestWindowFunctionIdentifier(c *C) {
	...
	for key := range parser2.WindowFuncTokenMapForTest {
...
// For issue #51
// See https://github.com/dean2021/sqlparser/pull/51 for details
...
// See https://github.com/dean2021/sqlparser/issue/94
...
// See https://github.com/dean2021/sqlparser/issue/95
...
func (s *testParserSuite) TestGBKEncoding(c *C) {
	...
	p.SetParserConfig(parser2.ParserConfig{CharsetClient: "gbk"})
	stmt, err = p.ParseOneStmt(sql, "", "")
	c.Assert(err, IsNil)
	_, _ = stmt.Accept(checker)
	...
	p.SetParserConfig(parser2.ParserConfig{CharsetClient: ""})
